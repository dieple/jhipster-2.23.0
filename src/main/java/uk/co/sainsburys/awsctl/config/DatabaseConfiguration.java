package uk.co.sainsburys.awsctl.config;

import uk.co.sainsburys.awsctl.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("uk.co.sainsburys.awsctl.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("uk.co.sainsburys.awsctl.repository.search")
